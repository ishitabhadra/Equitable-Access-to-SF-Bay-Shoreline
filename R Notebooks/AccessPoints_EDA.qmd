...
```{r}
access_raw <- read.csv("../Data/Shoreline-Access-Pts_v2-1-attribute-table.csv")
glimpse(access_raw)
...
```{r}
access_shp <- st_read("../Data/Shoreline_access_points/Shoreline_Access_Pts_v2_1.shp") |>
    st_transform(4326)
...
```{r}
# static plot of shapefile data
plot(st_geometry(access_shp))
```